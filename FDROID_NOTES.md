# F-Droid strategy for Etabli Atelier

This app bundles **WebR + Pyodide** as open-source WebAssembly. That is the one thing
...
`metadata/com.raban.etabli.atelier.yml`, pushing to your fork, and letting CI build it.
